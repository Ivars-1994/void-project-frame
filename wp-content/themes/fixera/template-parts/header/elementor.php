<?php 
$logo_m = fixera()->get_theme_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/img/logo.png', 'id' => '' ] );
$p_menu = fixera()->get_page_opt('p_menu');
$sticky_scroll = fixera()->get_theme_opt('sticky_scroll');
...
<header id="pxl-header-elementor" class="is-sticky">
    ...
    <?php if(isset($args['header_mobile_layout']) && $args['header_mobile_layout'] > 0) : 
        ...
        ?>
        <div id="pxl-header-mobile" class="pxl-header-elementor-mobile <?php echo esc_attr($header_mobile_type); ?>">
            <div class="pxl-header-content">
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="pxl-header-menu">
                            <div class="pxl-header-menu-scroll">
                                ...
                                <?php fixera_header_mobile_search_form(); ?>
