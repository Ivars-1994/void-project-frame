...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Menu Hidden Pxl', 'fixera'),
        'icon' => 'eicon-nav-menu',
        ...
        'params' => array(
            'sections' => array(
                ...
                array(
                    'name' => 'section_style_togglet',
                    'label' => esc_html__('Toggle Button Setting', 'fixera'),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'color_toggle',
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-nav-hidden .pxl-menu-toggle' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            'name' => 'bg_toggle',
                            'label' => esc_html__('Bacground', 'fixera' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-nav-hidden .pxl-menu-toggle' => 'background-color: {{VALUE}};',
                            ],
                        ),
                        array(
                            'name' => 'color_toggle_hv',
                            'label' => esc_html__('Color Hover', 'fixera' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-nav-hidden .pxl-menu-toggle:hover' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            'name' => 'bg_toggle_hv',
                            'label' => esc_html__('Bacground Hover', 'fixera' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-nav-hidden .pxl-menu-toggle:hover' => 'background-color: {{VALUE}};',
                            ],
                        )
                    ),
                ),
