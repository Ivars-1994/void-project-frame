...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Icon Box Carousel Pxl', 'fixera'),
        'icon' => 'eicon-alert',
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elements/templates/pxl_icon_box_carousel/img-layout/layout1.jpg'
                                ],
                                '2' => [
                                    'label' => esc_html__('Layout 2', 'fixera' ),
                                    'image' => get_template_directory_uri() . '/elements/templates/pxl_icon_box_carousel/img-layout/layout2.jpg'
                                ],
                                '3' => [
                                    'label' => esc_html__('Layout 3', 'fixera' ),
                                    'image' => get_template_directory_uri() . '/elements/templates/pxl_icon_box_carousel/img-layout/layout3.jpg'
                                ],
                            ],
                        ),
                    ),
