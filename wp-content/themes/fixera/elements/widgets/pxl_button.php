...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_button',
        'title' => esc_html__('Button Pxl', 'fixera' ),
        'icon' => 'eicon-button',
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'condition' => [
                                'btn_style' => [ 'btn-default', 'btn-gradient' ],
                            ],
                        ),
                        array(
                            'name'         => 'btn_box_shadow',
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-button .btn:hover, {{WRAPPER}} .pxl-button .btn:active, {{WRAPPER}} .pxl-button .btn:focus' => 'color: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-button .btn:hover, {{WRAPPER}} .pxl-button .btn:active, {{WRAPPER}} .pxl-button .btn:focus' => 'background-color: {{VALUE}} !important;',
                            ],
                            'condition' => [
                                'btn_style' => ['btn-default'],
                            ],
