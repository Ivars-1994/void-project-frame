...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Feature Marquee Pxl', 'fixera'),
        'icon' => 'eicon-person',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'marquee',
                            'label' => esc_html__('Image Marquee', 'fixera'),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'slip_type',
                            'label' => esc_html__('Slip Type', 'fixera' ),
                        ...
                        array(
                            'name' => 'slip_duration',
                            'label' => esc_html__('Slip Duration', 'fixera' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'default' => '20',
                        ),
                        array(
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'logo_margin',
                            'label' => esc_html__('Logo Margin', 'fixera' ),
                        ...
                        array(
                            'name' => 'logo_width',
                            'label' => esc_html__('Logo Box Width', 'fixera' ),
                        ...
                        array(
                            'name' => 'logo_width_f',
                            'label' => esc_html__('Logo Image Width', 'fixera' ),
