...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_blog_list',
        'title' => esc_html__('Blog List Pxl', 'fixera' ),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-grid-item + .pxl-grid-item' => 'margin-top: {{SIZE}}{{UNIT}};',
                            ],
                        ),
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-item--title a' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            'name' => 'title_color_hv',
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-item--title a:hover' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                        ...
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-item--author a' => 'color: {{VALUE}};',
                            ],
                        ),
                    ),
                ),
