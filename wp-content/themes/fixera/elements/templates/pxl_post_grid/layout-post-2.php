...
$style_display = $widget->get_setting('style_display');
    ...
    <?php if (!empty($next_link) && $pagination_type == 'loadmore') { ?>
        <div class="pxl-load-more" data-loadmore="<?php echo esc_attr(json_encode($load_more)); ?>">
            <span class="btn btn-loadmore">
                ...
                <span class="pxl-load-icon"><i class="bravisicon bravisicon-refresh"></i></span>
            </span>
        </div>
    <?php } ?>
</div>