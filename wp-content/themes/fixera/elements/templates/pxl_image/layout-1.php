...
?>
<div class="pxl-image-single <?php if(!empty($settings['img_effect'])) { echo esc_attr($settings['img_effect']); } ?> <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <?php if(!empty($settings['image']['id'])) : ?>
        <?php if ($settings['image_type'] == 'img') { 
            ...
            ?>
            <?php if($settings['type_link'] == 'img-link') { ?>
            ...
            <?php } else { ?> 
                <div class="pxl-item--inner pxl-item-light-box">
                    <?php if ( !empty( $settings['image']['url'] ) ) { echo wp_kses_post($thumbnail); } ?>
                    <a class="btn-zoom light-box" href="<?php echo wp_get_attachment_image_url( $settings['image']['id'], 'full') ?>">+</a>
                </div>
            <?php } ?>
        <?php } else { ?>
