...
if(isset($settings['icons']) && !empty($settings['icons']) && count($settings['icons'])): ?>
    <div class="pxl-icon1 <?php echo esc_attr( $settings['style'].' '.$settings['pxl_animate'] ); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
        <div class="inner-layout">
            <?php if ( $settings['style'] == 'style-3' && !empty($settings['icon_label']) ) { ?>
                <?php if(!empty($settings['icon_label'])) : ?>
                    <label><?php echo esc_html($settings['icon_label']); ?></label>
                <?php endif; ?>
            <?php } ?>
