...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-service-carousel pxl-service-carousel1 pxl-swiper-boxshadow">
                        ...
                        if (has_post_thumbnail($post->ID) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false)): 
                            ...
                            <div class="pxl-swiper-slide">
                                <div class="pxl-item--inner <?php echo esc_attr($settings['style_box'].' '.$pxl_animate); ?>" data-wow-duration="1.2s">
                                    ...
                                    <?php if($style_box == 'item-style1' || $style_box == 'item-style2') { ?>
                                    ...
                                    <?php } ?>
                                    <?php if($style_box == 'item-style2') { ?>
                                        <?php if($show_button == 'true') :?>
                                            <a class="btn-showmore-top" href="<?php if(!empty($service_external_link)) { echo esc_url($service_external_link); } else { echo esc_url(get_permalink( $post->ID )); } ?>">
                                                <span>
                                                    <?php if(!empty($button_text)) {
                                                        echo esc_attr($button_text);
                                                    } else {
