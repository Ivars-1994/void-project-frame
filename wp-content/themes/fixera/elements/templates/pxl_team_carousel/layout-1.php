...
<?php if(isset($settings['team']) && !empty($settings['team']) && count($settings['team'])): ?>
    <div class="pxl-swiper-sliders pxl-team pxl-team-carousel1 <?php echo esc_attr($settings['style_box']); ?>">
        <div class="pxl-carousel-inner <?php echo esc_attr($arrows_position); ?>">
            <?php if( !empty($settings['el_sub_title'] ) || !empty($settings['el_title']) || !empty($settings['el_excerpt']) || $arrows !== 'false' ) : ?>
                <div class="pxl-wrapper-heading">
                    <div class="el-wp-title">
                    ...
                    <?php if(!empty($settings['el_excerpt'])) : ?>
                        <div class="el-excerpt"><?php echo pxl_print_html($settings['el_excerpt']); ?></div>
                    <?php endif; ?>
                    <?php if( $arrows !== 'false' ) : ?>
                        <div class="el-arrows">
                            ...
                            <div class="pxl-item--inner <?php echo esc_attr($settings['pxl_animate']); ?>">
                                ...
                                <div class="pxl-item--meta">
                                    ...
                                    <div class="pxl-item--social">
                                        ...
                                        <span class="item--social-btn"><i class="icofont icofont-plus"></i></span>
                                    </div>
                                </div>
                           </div>
                        </div>
