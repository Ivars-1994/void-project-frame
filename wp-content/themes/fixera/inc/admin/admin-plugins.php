...
class Fixera_Admin_Plugins extends Fixera_Admin_Page {
	
	public function __construct() {
		$this->id = 'pxlart-plugins';
		$this->page_title = esc_html__( 'Install Plugins', 'fixera' );
		$this->menu_title = esc_html__( 'Install Plugins', 'fixera' );
		$this->parent = 'pxlart';
		parent::__construct();
	}
	...
	public function tgmpa_plugin_action( $plugin, $status ) {
		...
		switch( $status ) {
			case 'not-installed':
				$btn_class = 'white';
				$btn_text = esc_html_x( 'Install', 'Plugin installation page.', 'fixera' );
			...
			case 'installed':
				$btn_class = 'success';
				$btn_text = esc_html_x( 'Activate', 'Plugin installation page.', 'fixera' );
			...
			case 'active':
				$btn_class = 'danger';
				$btn_text = esc_html_x( 'Deactivate', 'Plugin installation page.', 'fixera' );
		...
		$btn_text_active = esc_html_x( 'Deactivate', 'Plugin installation page.', 'fixera' );
