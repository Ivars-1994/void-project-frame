<?php 
	...
	function pxl_get_system_info() {
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Upload max file size (64MB)', 'fixera' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Memory limit (256MB)', 'fixera' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Post max size (64MB)', 'fixera' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Max Execution Time (6s)', 'fixera' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Max input vars (3000)', 'fixera' ),
	...
	?>
		<div class="pxl-iconbox">
			<div class="pxl-icon-container">
				<?php if ( $item['status'] ) : ?>
					<img src="<?php echo esc_url(get_template_directory_uri() . '/inc/admin/assets/img/check.png'); ?>" alt="<?php esc_attr_e( 'Check', 'fixera' ); ?>">
				<?php else : ?>
					<img src="<?php echo esc_url(get_template_directory_uri() . '/inc/admin/assets/img/crossed.png'); ?>" alt="<?php esc_attr_e( 'Un Check', 'fixera' ); ?>">
				<?php endif; ?>
			</div>
