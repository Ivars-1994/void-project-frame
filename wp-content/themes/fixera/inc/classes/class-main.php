...
if (!class_exists('Fixera_Main')) { 
    class Fixera_Main extends Fixera_Base
    {
        ...
        public function get_sidebar_args($args = []){
            ...
            $sidebars = ['content_class' => 'col-lg-8', 'sidebar_class' => 'col-lg-4', 'wrap_class' => 'pxl-content-wrap'];
...
function fixera() {
    return Fixera_Main::getInstance();
}
// Install
fixera(); 
